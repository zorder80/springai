package com.flavio.springai.services;//package com.flavio.springai.services;
//
...
//@Service
//@Slf4j
//public class BotChatManualMemoryService {
//
...
//
//	public BotChatManualMemoryService(ChatClient chatClient,
...
//
//		//add history
//		botChatHistory.messages().add(new BotChatQuestion(query, answer, ""));
//
//		return answer;
//	}
//
//	/*
//	 * save the user message and the botMessage to the vector store for store context
//	 */
